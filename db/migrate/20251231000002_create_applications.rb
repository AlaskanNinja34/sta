# db/migrate/20251231000002_create_applications.rb
# Phase 1: Create normalized applications table
# This replaces the old scholarship_applications table with proper linking fields

class CreateApplications < ActiveRecord::Migration[8.0]
  def change
    create_table :applications do |t|
      # === NEW LINKING FIELDS ===
      t.string :application_key, null: false  # "YYYY-NNN" format, unique identifier
      t.string :tribal_id, null: false        # Links to students table
      t.integer :application_year, null: false # Year of application (e.g., 2025)
      t.string :application_type, default: 'digital' # 'digital' or 'historical_import'
      ...
      t.string :school_issued_student_id      # Renamed from student_id for clarity
    ...
    # === INDEXES ===
    add_index :applications, :application_key, unique: true
    add_index :applications, :tribal_id
    add_index :applications, :application_year
    add_index :applications, :status
    add_index :applications, :board_status
    add_index :applications, :finance_grant_number
    add_index :applications, [:tribal_id, :application_year]
  end
end
